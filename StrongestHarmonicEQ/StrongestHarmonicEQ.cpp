...
public:
    StrongestHarmonicEQ()
    {
        ...
        // Install the processing callback immediately. SynthEdit normally calls
        // onSetPins() at graph startup as well, but setting it here removes any
        // dependency on callback ordering.
