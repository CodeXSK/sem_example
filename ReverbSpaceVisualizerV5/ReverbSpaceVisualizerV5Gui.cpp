...
class ReverbSpaceVisualizerV5Gui final : public SeGuiCompositedGfxBase
{
public:
    explicit ReverbSpaceVisualizerV5Gui(IMpUnknown* host)
        : SeGuiCompositedGfxBase(host)
    {
        initializePin(0,  pinSize,       static_cast<MpGuiBaseMemberPtr>(&ReverbSpaceVisualizerV5Gui::onChanged));
        initializePin(1,  pinDiffusion,  static_cast<MpGuiBaseMemberPtr>(&ReverbSpaceVisualizerV5Gui::onChanged));
        initializePin(2,  pinDecay,      static_cast<MpGuiBaseMemberPtr>(&ReverbSpaceVisualizerV5Gui::onChanged));
        initializePin(3,  pinLowDamp,    static_cast<MpGuiBaseMemberPtr>(&ReverbSpaceVisualizerV5Gui::onChanged));
        initializePin(4,  pinHighDamp,   static_cast<MpGuiBaseMemberPtr>(&ReverbSpaceVisualizerV5Gui::onChanged));
        initializePin(5,  pinPreDelay,   static_cast<MpGuiBaseMemberPtr>(&ReverbSpaceVisualizerV5Gui::onChanged));
        initializePin(6,  pinEarlyLevel, static_cast<MpGuiBaseMemberPtr>(&ReverbSpaceVisualizerV5Gui::onChanged));
        initializePin(7,  pinLateLevel,  static_cast<MpGuiBaseMemberPtr>(&ReverbSpaceVisualizerV5Gui::onChanged));
        initializePin(8,  pinDensity,    static_cast<MpGuiBaseMemberPtr>(&ReverbSpaceVisualizerV5Gui::onChanged));
        initializePin(9,  pinGlow,       static_cast<MpGuiBaseMemberPtr>(&ReverbSpaceVisualizerV5Gui::onChanged));
        initializePin(10, pinLineWidth,  static_cast<MpGuiBaseMemberPtr>(&ReverbSpaceVisualizerV5Gui::onChanged));
        initializePin(11, pinMirror,     static_cast<MpGuiBaseMemberPtr>(&ReverbSpaceVisualizerV5Gui::onChanged));
        initializePin(12, pinBrightness, static_cast<MpGuiBaseMemberPtr>(&ReverbSpaceVisualizerV5Gui::onChanged));
        initializePin(13, pinCurveLevel, static_cast<MpGuiBaseMemberPtr>(&ReverbSpaceVisualizerV5Gui::onChanged));
        initializePin(14, pinBgR,        static_cast<MpGuiBaseMemberPtr>(&ReverbSpaceVisualizerV5Gui::onChanged));
        initializePin(15, pinBgG,        static_cast<MpGuiBaseMemberPtr>(&ReverbSpaceVisualizerV5Gui::onChanged));
        initializePin(16, pinBgB,        static_cast<MpGuiBaseMemberPtr>(&ReverbSpaceVisualizerV5Gui::onChanged));
        initializePin(17, pinMainR,      static_cast<MpGuiBaseMemberPtr>(&ReverbSpaceVisualizerV5Gui::onChanged));
        initializePin(18, pinMainG,      static_cast<MpGuiBaseMemberPtr>(&ReverbSpaceVisualizerV5Gui::onChanged));
        initializePin(19, pinMainB,      static_cast<MpGuiBaseMemberPtr>(&ReverbSpaceVisualizerV5Gui::onChanged));
        initializePin(20, pinHiR,        static_cast<MpGuiBaseMemberPtr>(&ReverbSpaceVisualizerV5Gui::onChanged));
        initializePin(21, pinHiG,        static_cast<MpGuiBaseMemberPtr>(&ReverbSpaceVisualizerV5Gui::onChanged));
        initializePin(22, pinHiB,        static_cast<MpGuiBaseMemberPtr>(&ReverbSpaceVisualizerV5Gui::onChanged));
        initializePin(23, pinWidthPx,    static_cast<MpGuiBaseMemberPtr>(&ReverbSpaceVisualizerV5Gui::onChanged));
        initializePin(24, pinHeightPx,   static_cast<MpGuiBaseMemberPtr>(&ReverbSpaceVisualizerV5Gui::onChanged));
    }
    ...
    int32_t MP_STDCALL paint(HDC hDC) override
    {
        ...
        auto curveY = [&](float u)
        {
            ...
            const float env = curveLevel * clamp01(0.72f * earlyLevel * early + 0.48f * lateLevel * tail);
...
private:
    FloatGuiPin pinSize, pinDiffusion, pinDecay, pinLowDamp, pinHighDamp;
...
REGISTER_GUI_PLUGIN(ReverbSpaceVisualizerV5Gui, L"Pandocrator Reverb Space Visualizer v5");
