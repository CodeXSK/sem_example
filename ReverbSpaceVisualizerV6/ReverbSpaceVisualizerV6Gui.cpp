...
public:
    ...
    int32_t MP_STDCALL OnRender(GmpiDrawing_API::IMpDeviceContext* drawingContext) override
    {
        ...
        int events = static_cast<int>((10.0f + 176.0f * diffusionShape) * densityTrim);
        events = (std::max)(8, (std::min)(220, events));
        ...
        const int segments = (std::max)(64, (std::min)(360, static_cast<int>(plotW / 2.8f)));
        auto curveY = [&](float u)
        {
            if (u < pre)
                return horizon;
