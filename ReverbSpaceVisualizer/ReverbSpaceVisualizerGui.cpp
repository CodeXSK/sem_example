...
class ReverbSpaceVisualizerGui final : public MpGuiGfxBase
{
public:
    ReverbSpaceVisualizerGui()
    {
        initializePin(pinSize,        static_cast<MpGuiBaseMemberPtr2>(&ReverbSpaceVisualizerGui::refresh));
        initializePin(pinDiffusion,   static_cast<MpGuiBaseMemberPtr2>(&ReverbSpaceVisualizerGui::refresh));
        initializePin(pinDecay,       static_cast<MpGuiBaseMemberPtr2>(&ReverbSpaceVisualizerGui::refresh));
        initializePin(pinLowDamp,     static_cast<MpGuiBaseMemberPtr2>(&ReverbSpaceVisualizerGui::refresh));
        initializePin(pinHighDamp,    static_cast<MpGuiBaseMemberPtr2>(&ReverbSpaceVisualizerGui::refresh));
        initializePin(pinPreDelay,    static_cast<MpGuiBaseMemberPtr2>(&ReverbSpaceVisualizerGui::refresh));
        initializePin(pinEarlyLevel,  static_cast<MpGuiBaseMemberPtr2>(&ReverbSpaceVisualizerGui::refresh));
        initializePin(pinLateLevel,   static_cast<MpGuiBaseMemberPtr2>(&ReverbSpaceVisualizerGui::refresh));
        initializePin(pinDensity,     static_cast<MpGuiBaseMemberPtr2>(&ReverbSpaceVisualizerGui::refresh));
        initializePin(pinGlow,        static_cast<MpGuiBaseMemberPtr2>(&ReverbSpaceVisualizerGui::refresh));
        initializePin(pinLineWidth,   static_cast<MpGuiBaseMemberPtr2>(&ReverbSpaceVisualizerGui::refresh));
        initializePin(pinMirror,      static_cast<MpGuiBaseMemberPtr2>(&ReverbSpaceVisualizerGui::refresh));
        initializePin(pinBrightness,  static_cast<MpGuiBaseMemberPtr2>(&ReverbSpaceVisualizerGui::refresh));
        initializePin(pinCurveLevel,  static_cast<MpGuiBaseMemberPtr2>(&ReverbSpaceVisualizerGui::refresh));

        initializePin(pinBgR,         static_cast<MpGuiBaseMemberPtr2>(&ReverbSpaceVisualizerGui::refresh));
        initializePin(pinBgG,         static_cast<MpGuiBaseMemberPtr2>(&ReverbSpaceVisualizerGui::refresh));
        initializePin(pinBgB,         static_cast<MpGuiBaseMemberPtr2>(&ReverbSpaceVisualizerGui::refresh));
        initializePin(pinMainR,       static_cast<MpGuiBaseMemberPtr2>(&ReverbSpaceVisualizerGui::refresh));
        initializePin(pinMainG,       static_cast<MpGuiBaseMemberPtr2>(&ReverbSpaceVisualizerGui::refresh));
        initializePin(pinMainB,       static_cast<MpGuiBaseMemberPtr2>(&ReverbSpaceVisualizerGui::refresh));
        initializePin(pinHiR,         static_cast<MpGuiBaseMemberPtr2>(&ReverbSpaceVisualizerGui::refresh));
        initializePin(pinHiG,         static_cast<MpGuiBaseMemberPtr2>(&ReverbSpaceVisualizerGui::refresh));
        initializePin(pinHiB,         static_cast<MpGuiBaseMemberPtr2>(&ReverbSpaceVisualizerGui::refresh));

        initializePin(pinWidthPx,     static_cast<MpGuiBaseMemberPtr2>(&ReverbSpaceVisualizerGui::refresh));
        initializePin(pinHeightPx,    static_cast<MpGuiBaseMemberPtr2>(&ReverbSpaceVisualizerGui::refresh));
    }
...
GMPI_REGISTER_GUI(
    MP_SUB_TYPE_GUI2,
    ReverbSpaceVisualizerGui,
    L"Pandocrator Reverb Space Visualizer v1"
);
